...
#Guió encarregat en ajudar a migrar codi amb Chat-GPT
#Ús: -Executar el guió
#    -Copiar el "prompt" i enganxar-lo al xat de Chat-GPT
#    -Eliminar les linies buides de la sortida (es poden usar eines online per anar més ràpid)
#    -Enganxar la sortida sense linies en blanc i premer retorn
#    -Repetir el procés
